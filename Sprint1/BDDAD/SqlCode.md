...
CREATE TABLE MaterialBOM (
                             QuantityMaterial number(10) NOT NULL,
                             MaterialID       varchar2(255) NOT NULL,
                             PartNumber       varchar2(255) NOT NULL,
                             ProductID        varchar2(255) NOT NULL);
...
CREATE TABLE Product_Orders (
                                ProductID        varchar2(255) NOT NULL,
                                OrderID          varchar2(255) NOT NULL,
                                QuantityProducts number(10) NOT NULL,
                                PRIMARY KEY (ProductID,
                                             OrderID));
...
ALTER TABLE ProductionOrder ADD CONSTRAINT FKProduction491612 FOREIGN KEY (OPID) REFERENCES Operation (OPID);
